namespace JasonSkillman.SceneSwitcher.Editor {
	using UnityEditor;
	...
	public class SceneSwitcherWindow : EditorWindow {
		...
		private struct SceneAsset {
			...
			public SceneAsset(string guid) { GUID = guid; }
		}
		...
		private void LoadScene(int index, OpenSceneMode mode = OpenSceneMode.Single) { EditorSceneManager.OpenScene(sceneObjs[index].Path, mode); }
